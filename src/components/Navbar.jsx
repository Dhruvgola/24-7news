    ...
    return (
      <>
        <div className="nav">
          ...
          {/* news name */}
          <h3 className="main-heading">24/7 News</h3>

          {/* social media handles */}

          <div className="handles ">
            <a
              href="https://twitter.com/i/flow/login?redirect_after_login=%2F%3Flogout%3D1689713607565"
              target="_blank"
            >
            ...
            <a href="https://www.instagram.com/" target="_blank">
              <i className="fa fa-instagram px-3"></i>
            </a>
          </div>
          ...
          <div className="sidebar " id="sideNavigation">
            ...
            <div className="d-flex flex-column mb-3 " id="sidebar-content">
              ...
              <Link className="item " to="/buisness">
                Buisness
              </Link>
              <Link className="item" to="/entertainment">
                Entertainment{" "}
              </Link>
              <Link className="item " to="/health">
                health
              </Link>
              <Link className="item" to="/science">
                science{" "}
              </Link>
